...
![files tab upload button not working](notworkingbutton.png)
...
![webshell injected in theme editor](themeeditor.png)
...
![www-data output confirming RCE](reverseshelltest.png)
